package com.heapot.qianxun.tools;
...
public class MyGridView extends GridView {
    ...
    private OnItemLongClickListener onItemLongClickListener = new OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
            ...
            //设置被长按item不显示
            ((SubscribedAdapter) getAdapter()).hideView(position);
            return true;
        }
    };
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if ((currentDraggedPosition != AdapterView.INVALID_POSITION) && (currentDraggedPosition != preDraggedOverPosition)) {
                ((SubscribedAdapter) getAdapter()).swapView(preDraggedOverPosition, currentDraggedPosition);
            ...
            ((SubscribedAdapter) getAdapter()).showHideView();
            if ((int) dragImageView.getTag() == DRAG_IMG_SHOW) {
                windowManager.removeView(dragImageView);
                dragImageView.setTag(DRAG_IMG_NOT_SHOW);
            }
